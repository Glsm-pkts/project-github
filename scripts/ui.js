import { elements } from "./halper.js";
...
export class UI {
    ...
    renderProfile(res){
       ...
       const created_at = new Date (res.created_at).toLocaleDateString()
        ...
        <div class="col-md-3">
            ...
            alt="" class="img-fluid rounded shadow img">
    ...
    showAlert(message, className) {
        ...
        //uyarıyı ekrandan silme fonksiyonunu showAlert çalıştıktan 3 saniye sonra çalıştırır
        setTimeout(() => {
            this.clearAlert()
        },3000);
    }
    ...
    //!ekran temizleme ve bildirim basma
    clearProfile(e){
        e.preventDefault();
      if(confirm("Silmek istediğinize emin misinziz")){
